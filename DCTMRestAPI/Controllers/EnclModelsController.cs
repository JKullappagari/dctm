...
namespace DCTMRestAPI.Controllers
{
    ...
    public class EnclModelsController : Controller
    {

        private readonly DCTrackContext _context;

        public EnclModelsController(DCTrackContext context)
        {
            _context = context;
        ...
        /// <summary>
        /// Gets all enclosure model specifications
        /// </summary>
        /// <returns></returns>
        // GET: api/enclmodels
        [HttpGet]
        ...
        /// <summary>
        /// Gets enclosure model specifications based on identifier
        /// </summary>
        /// <param name="EnclModelId"></param>
        /// <returns></returns>
        // GET api/enclmodels/5
        [HttpGet("{EnclModelId}")]
        [ProducesResponseType(typeof(TblEnclModelDetails), 200)]
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        ...
        /// <summary>
        /// Gets enclosure model specifications which are modified after Last Updated datetime
        /// </summary>
        // GET api/enclmodels/5
