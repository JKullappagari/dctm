...
namespace DCTMRestAPI.Controllers
{
    ...
    public class ServerPropertiesController : Controller
    {
        ...
        public DateTime Get()
        {
            List<TblServerProperties> serverPorp = _context.TblServerProperties.FromSql(@"select 1 as 'Id',getdate() as 'serverdatetimelocal',getutcdate() as 'serverdatetimeutc'").ToList();
