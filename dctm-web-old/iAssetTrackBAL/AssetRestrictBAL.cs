...
[DALCOperationSP(InsertSP = "", DeleteSP = "", UpdateSP = StoredProcedures.SP_ASSET_RESTRICTION)]
   public class AssetRestrictionBAL
    {
      ...
      public void Persist(DALCOperation operation)
      {
            ...
            {
                DALCBase<AssetRestrictionBAL> dalc = new DALCBase<AssetRestrictionBAL>(this);
