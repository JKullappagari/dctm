/*
File Name:	AssetDeWriteoffBAL.cs
...
[DALCOperationSP(InsertSP = "", DeleteSP = "", UpdateSP = StoredProcedures.SP_ASSET_DEWRITEOFF)]
   public class AssetDeWriteoffBAL
    {
      ...
      public void Persist(DALCOperation operation)
      {
            ...
            {
                DALCBase<AssetDeWriteoffBAL> dalc = new DALCBase<AssetDeWriteoffBAL>(this);
       ...
       /// <author>Atchuta</author>
       /// <createdOn>27 Dec 2006</createdOn>
       public DataRow FillWriteoffDetails()
       {
           DALCCommandHelper criteria = new DALCCommandHelper(StoredProcedures.SP_ASSET_WRITEOFF_DETAILS, DALCResultType.DataSet);
           criteria.AddInParameter(Parameters.PARAM_ASSETID, DbType.Int32, intAssetID);
           DataSet ds = (DataSet)criteria.ExecuteCommand();
           Dictionary<string, object> output = criteria.OutputParameters;
           if (ds.Tables[0].Rows.Count > 0)
