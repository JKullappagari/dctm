<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" CodeFile="BUDivAssignment.aspx.cs" Inherits="BUDivAssignment"
    Title="Business Unit and Division Assignment" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<asp:Content ID="ContentMainPage" ContentPlaceHolderID="Master_ContentPlaceHolder"
                        ...
                        <td valign="top" style="width: 100%; height: 35px;">
                            ...
                            <table id="Table2" cellspacing="2" cellpadding="2" border="0" align="left">
                                <tr style="height: 15px;">
                                    <td style="height: 214px; width: 244px;" align="left">
                                        <asp:Label ID="lblDivision1" runat="server" CssClass="FieldName" meta:resourcekey="lblDivision1Resource1"> </asp:Label><br />
                                        <br />
                                        &nbsp;
                                        <asp:ListBox ID="lbAvDivision" runat="server" CssClass="listboxText" TabIndex="3"
                                            Width="236px" Height="154px" SelectionMode="Multiple" Font-Names="Tahoma" Font-Size="8pt"
                                            ForeColor="#000040" meta:resourcekey="lbAvDivisionResource1"></asp:ListBox>
                                    </td>
                                    <td style="width: 2px; height: 214px;">
                                        <br />
                                        <br />
                                        <br />
                                        <table style="width: 26px">
                                            <tr>
                                                <td style="width: 25px;" class="ControlTD" align="left">
                                                    <igtxt:WebImageButton ID="ibRight" runat="server" Height="27px" UseBrowserDefaults="False"
                                                        ToolTip="Right" Width="19px" TabIndex="4" OnClick="ibRight_Click" ImageDirectory=""
                                                        meta:resourcekey="ibRightResource1">
                                    ...
                                    <td style="height: 214px; width: 288px;" align="left">
                                        <asp:Label ID="lblDivision2" runat="server" CssClass="FieldName" meta:resourcekey="lblDivision2Resource1"> </asp:Label><br />
                                        <br />
                                        <asp:ListBox ID="lbAsDivision" runat="server" CssClass="listboxText" TabIndex="8"
                                            Width="236px" Height="154px" SelectionMode="Multiple" Font-Names="Tahoma" Font-Size="8pt"
                                            ForeColor="#000040" meta:resourcekey="lbAsDivisionResource1"></asp:ListBox>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:HiddenField ID="hdnDivisionsWithAppl" runat="server" />
</asp:Content>
