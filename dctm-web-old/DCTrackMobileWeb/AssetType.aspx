<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" CodeFile="AssetType.aspx.cs" Inherits="AssetType" Title="Asset Group"
                ...
                <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <table id="Table3" style="height: 100%;" cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr style="height: 15px;">
                                    ...
                                    <td class="ControlTD" style="height: 34px">
                                        <asp:TextBox ID="txtAssetType" runat="server" Width="227px" CssClass="FieldValue"
                                            MaxLength="25" Height="16px" TabIndex="1" meta:resourcekey="txtAssetTypeResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="reqBUVal" runat="server" CssClass="ErrValStyle" ControlToValidate="txtAssetType"
                                            TabIndex="7" meta:resourcekey="reqBUValResource1"></asp:RequiredFieldValidator>
                                        <%--<asp:RegularExpressionValidator ID="regDocGroupVal" runat="server" ControlToValidate="txtAssetType"
                                            CssClass="ErrValStyle" Display="Dynamic" ErrorMessage="Invalid Asset Type - use alphabets/digits and no spaces allowed"
                                            ValidationExpression="^[A-Za-z0-9]+" Height="15px" Width="166px" ValidationGroup="valAssetTypeSummary" ></asp:RegularExpressionValidator>--%>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2" valign="top" style="height: 30px">
                                                   <igtxt:WebImageButton ID="ibCreate" runat="server" UseBrowserDefaults="False" OnClick="ibCreate_Click"
                                                        TabIndex="7" SkinID="uwButton" ImageDirectory="" meta:resourcekey="ibCreateResource1">
                                                    ...
                                                    <igtxt:WebImageButton ID="ibReset" runat="server" UseBrowserDefaults="False" CausesValidation="False"
                                                        OnClick="ibReset_Click" SkinID="uwButton" ImageDirectory="" TabIndex="8" meta:resourcekey="ibResetResource1">
                                                    </igtxt:WebImageButton>
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 100%;" align="center">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td style="width: 100%; margin-left: 40px;" align="left">
                                                    <ig:WebDataGrid ID="grdAssetType" runat="server" AutoGenerateColumns="False" DataKeyFields="AssetGroupID"
                                                        OnDataFiltered="grdAssetType_DataFiltered" Width="98%" EnableRelativeLayout="True"
                                                        OnItemCommand="grdAssetType_ItemCommand" Height="300px" OnDataBound="grdAssetType_DataBound"
                                                        HeaderCaptionCssClass="GridHeader" OnInitializeRow="grdAssetType_InitializeRow">
                                                        <Columns>
                                                            <ig:BoundDataField DataFieldName="AssetGroup" Key="AssetGroup">
                                                            ...
                                                            <ig:TemplateDataField Key="Edit">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ImageUrl="~/images/edit_line.gif" runat="server" CausesValidation="False"
                                                                        CommandArgument='<%# Eval("AssetGroupID") %>' CommandName="Edit" ID="ibEdit"
                                                            ...
                                                            <ig:TemplateDataField Key="Delete">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblDeleteID" runat="server" Text='<%# Bind("AssetGroupID") %>' Visible="False"
                            ...
                            <asp:ValidationSummary ID="valAssetTypeSummary" runat="server" CssClass="ErrValSummary"
                                ShowSummary="False" meta:resourcekey="valAssetTypeSummaryResource1" />
