<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptTransactionsList.aspx.cs"
    Inherits="RptTransactionsList" MasterPageFile="~/iAssetTrackMasterPage.master"
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td class="ControlTD" align="left" valign="bottom" style="width: 20%">
                                                            <asp:DropDownList ID="ddlTransType" runat="server" CssClass="dropdownText" meta:resourcekey="ddlTransTypeResource1"
        ...
        <tr>
            <td valign="top" align="left">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" ShowParameterPrompts="False"
                    KeepSessionAlive="true" Style="overflow: auto;" ShowFindControls="false" ShowBackButton="false"
