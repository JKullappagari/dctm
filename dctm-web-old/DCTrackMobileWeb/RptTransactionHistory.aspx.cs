...
public partial class RptTransactionHistory : System.Web.UI.Page
{
    #region "Declarations"
    ...
    protected DropDownList ddlBusinessUnit, ddlPrimarySite, ddlSite, ddlMfg, ddlTransStatus;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ddlTransStatus = (DropDownList)this.wpSearchOptions.Groups[0].Items[0].FindControl("ddlTransStatus");
        ...
        Session["PageHeader"] = "Asset History Report";
        _dtRights = (DataTable)(Session["Rights"]);

        if (_dtRights == null)
        {
            Session["RedirectUrl"] = "RptTransactionHistory.aspx";
            Response.Redirect("Login.aspx");
        }

        bool blfoundPage = false;

        if (_dtRights.Select("Module = 'Asset History Report' and Rights = '" + "View" + "'").Length != 0)
        {
            blfoundPage = true;
        }
        ...
        if (!IsPostBack)
        {
            FillDropDownLists(StoredProcedures.SP_GETTRANSACTIONSTATUS, ddlTransStatus);
            LoadLocations();
        }
    ...
    protected void btnShowReport_Click(object sender, EventArgs e)
    {
        ...
        param[4] = new ReportParameter("TransStatus", ddlTransStatus.SelectedItem.Value);
        ...
        ReportViewer1.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportServerFolder"] + "AssetHistory";
        ...
        //}
        //this.wpSearchOptions.Expanded = false;//J00007 by kjb on 26 Sep 2012
