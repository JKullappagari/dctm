...
public partial class RptRackTagDetails : System.Web.UI.Page
{
    #region "Declarations"
    DataTable _dtRights;
    #endregion
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["PageHeader"] = "Rack Tag Details";
        _dtRights = (DataTable)(Session["Rights"]);

        if (_dtRights == null)
        {
            Session["RedirectUrl"] = "RptRackTagDetails.aspx";
            Response.Redirect("Login.aspx");
        }

        bool blfoundPage = false;

        if (_dtRights.Select("Module = 'Rack Tag Details' and Rights = '" + "View" + "'").Length != 0)
        {
            blfoundPage = true;
        }
        ...
        if (!Page.IsPostBack)
        {
            ...
            ReportViewer1.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportServerFolder"] + "RackTagDetails";
