<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" CodeFile="BUSiteAssignment.aspx.cs" Inherits="ASPX_BUSiteAssignment"
    Title="Company and Site Assignment" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<asp:Content ID="ContentMainPage" ContentPlaceHolderID="Master_ContentPlaceHolder"
                    ...
                    <tr>
                        ...
                        <td valign="top" style="width: 100%; height: 35px;">
                            <table id="Table3" cellspacing="2" cellpadding="2" width="100%" border="0">
                                <tr>
                                    <td class="labelTD" style="width: 67px;">
                            ...
                            <table id="Table2" cellspacing="2" cellpadding="2" border="0" align="left">
                                <tr style="height: 15px;">
                                    <td style="height: 214px; width: 243px;" align="Left">
                                        ...
                                        <br />
                                        &nbsp;<asp:ListBox ID="lbAvSite" runat="server" CssClass="listboxText" TabIndex="3" Width="236px"
                                            Height="154px" SelectionMode="Multiple" Font-Names="Tahoma" Font-Size="8pt" ForeColor="#000040"
                                            meta:resourcekey="lbAvSiteResource1"></asp:ListBox>
                                    </td>
                                    <td style="width: 2px; height: 214px;" align="left" colspan="2">
                                    ...
                                    <td style="height: 214px; width: 288px;" align="left">
                                        ...
                                        <br />
                                        <asp:ListBox ID="lbAsSite" runat="server" CssClass="listboxText" TabIndex="8" Width="236px"
                                            Height="154px" SelectionMode="Multiple" Font-Names="Tahoma" Font-Size="8pt" ForeColor="#000040"
                                            meta:resourcekey="lbAsSiteResource1"></asp:ListBox>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:HiddenField ID="hdnSitesWithLocation" runat="server" />
</asp:Content>
