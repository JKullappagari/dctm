<%@ Page Title="Import Blade Assets" Language="C#" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" Theme="SkinFile" CodeFile="ImportBlades.aspx.cs" Inherits="ImportBlades"
...
<asp:Content ID="Content1" ContentPlaceHolderID="Master_ContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function onFileUploaded(e, args) {
            ...
            $.ajax({
                type: "POST",
                url: "ImportBlades.aspx/ShowFileStats",
                data: fileName,
                                        ...
                                        <div style="width: 100%">
                                            <ig:WebDataGrid ID="grdAsset" runat="server" AutoGenerateColumns="False" DataKeyFields="ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ig:BoundDataField DataFieldName="ParentSerialNo" Key="ParentSerialNo">
                                                        <Header Text="ParentSerialNo" />
                                                    </ig:BoundDataField>
                                                    <ig:BoundDataField DataFieldName="ParentAssetTag" Key="ParentAssetTag">
                                                        <Header Text="ParentAssetTag" />
                                                    </ig:BoundDataField>
