<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAppSummaryByRack.aspx.cs"
    Inherits="RptAppSummaryByRack" MasterPageFile="~/iAssetTrackMasterPage.master"
    Theme="SkinFile" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>

<%@ Register Assembly="Infragistics45.Web.jQuery.v16.1, Version=16.1.20161.2236, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" Namespace="Infragistics.Web.UI.EditorControls" TagPrefix="ig" %>
...
<asp:Content ID="RptRackInventory" ContentPlaceHolderID="Master_ContentPlaceHolder"
    runat="Server">
                                    ...
                                    <table id="Table1" align="center" border="0" cellpadding="0" cellspacing="2" style="border-right: gray 1px solid;
                                        ...
                                        <tr>
                                            <td style="width: 138px; text-align: left; height: 26px;" valign="top">
                                                <asp:Label ID="lblSite" runat="server" CssClass="FieldName" meta:resourcekey="lblSiteResource1"
                                                    Width="138px"></asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="ControlTD" style="height: 19px; width: 138px;" valign="top">
                                                <asp:Label ID="lblAppCriticality" runat="server" CssClass="FieldName" meta:resourcekey="lblAppCriticalityResource1"
                                                    Width="138px"></asp:Label>
                                            </td>
                                            <td valign="top">
                                                <asp:DropDownList ID="ddlAppCriticality" runat="server" AutoPostBack="True" CssClass="dropdownText"
                                                    meta:resourcekey="ddlAppCriticalityResource1" OnSelectedIndexChanged="ddlAppCriticality_SelectedIndexChanged"
                                                    TabIndex="5" Width="140px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="ControlTD" style="height: 19px; width: 138px;" valign="top">
                                                <asp:Label ID="lblApplication" runat="server" CssClass="FieldName" meta:resourcekey="lblApplicationResource1"
                                                    Width="138px"></asp:Label>
                                            </td>
                                            <td valign="top">
                                                <asp:DropDownList ID="ddlApplication" runat="server" AutoPostBack="True" CssClass="dropdownText"
                                                    meta:resourcekey="ddlApplicationResource1" TabIndex="6" Width="140px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
