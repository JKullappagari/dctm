...
public partial class RptRackInventory : System.Web.UI.Page
{
    ReportParameter[] parm;
    LocationBAL objLocation;
    DataTable _dtRights;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["PageHeader"] = "Rack Inventory Report";
        _dtRights = (DataTable)(Session["Rights"]);

        if (_dtRights == null)
        {
            Session["RedirectUrl"] = "RptRackInventory.aspx";
            Response.Redirect("Login.aspx");
        }

        bool blfoundPage = false;

        if (_dtRights.Select("Module = 'Rack Inventory Report' and Rights = '" + "View" + "'").Length != 0)
        {
            blfoundPage = true;
        }
    ...
    protected void btnShowReport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ReportViewer1.ServerReport.ReportPath = ConfigurationManager.AppSettings["ReportServerFolder"] + "RackInventory";
