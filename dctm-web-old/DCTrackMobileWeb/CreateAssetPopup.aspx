<%@ Page Language="C#" MasterPageFile="~/PopupMaster.master" Theme="SkinFile" AutoEventWireup="true"
    CodeFile="CreateAssetPopup.aspx.cs" Inherits="CreateAssetPopup" Culture="auto"
...
<asp:Content ID="ContentCreateAsset" ContentPlaceHolderID="GeneralPopupContentPlaceHolder"
    runat="Server">
    <script id="Infragistics" type="text/javascript">
    </script>
    <script id="popup" type="text/javascript">
//<!--
        function setModelDisplay(locationType) {
        ...
        function PopUpWindowCallBack(id, name, Site, locId, locname, ParentAssetId) {
            ...
            if (ParentAssetId > 0) {
                ...
                //                var myLoc = document.getElementById('imgLocButton');
                //                myLoc.className = "disabled";
        ...
        //*V3.8-Added on 25Oct2013-By Amar Vidya
                    ...
                    <Template>
                        <table>
                            ...
                            <tr style="height: 29px;">
                                ...
                                <td align="left" class="ControlTD" style="width: 10%;" valign="top">
                                </td>
                                    ...
                                    <table class="leftaligned" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="ControlTD" align="left" valign="top">
                                                ...
                                                <%--<asp:HyperLink ID ="hlSelModel" runat="server" ImageUrl ="images/search.gif" NavigateUrl ="javascript:openModelList('TreeList.aspx?Type=Models&MfgName=<%=ddlMfgName %>&MfgID=<%=ddlMfgID %>&BU=<%=ddlBusinessUnitVal %>&Header=AssetModel');"
                                                    Text="Select Model" Style="border: 0;"></asp:HyperLink>--%>
                            ...
                            <tr style="height: 29px;">
                                ...
                                <td class="ControlTD" style="width: 25%;" valign="top">
                                    <asp:DropDownList ID="ddlOrientation" runat="server" CssClass="FieldValue" meta:resourcekey="ddlOrientationResource"
                                        OnSelectedIndexChanged="ddlOrientation_SelectedIndexChanged" AutoPostBack="true"
                                        TabIndex="10" Width="160px">
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr style="height: 29px;">
                                ...
                                <td class="ControlTD" align="left" valign="top" style="width: 25%;">
                                    <asp:TextBox ID="txtOS" runat="server" CssClass="FieldValue" meta:resourcekey="txtOSResource1" MaxLength="50"
                                        TabIndex="16" Width="160px"></asp:TextBox>
                                </td>
                                ...
                                <td class="ControlTD" style="width: 25%;" valign="top">
                                    <asp:TextBox ID="txtCPU" runat="server" CssClass="FieldValue" meta:resourcekey="txtCPUResource1" MaxLength="50"
                                        TabIndex="17" Width="160px"></asp:TextBox>
                                </td>
                            ...
                            <tr style="height: 29px;">
                                ...
                                <td class="labelTD" style="height: 29px; width: 600px;" valign="top" align="left">
                                </td>
                            </tr>
                            <tr style="height: 29px;">
                                <td class="labelTD" style="width: 10%;" valign="top" align="left">
                                ...
                                <td class="labelTD" style="width: 10%;">
                                </td>
                            </tr>
                            <tr style="height: 29px;">
