<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" CodeFile="Division.aspx.cs" Inherits="Division" Title="Division"
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table id="Table3" style="height: 100%;" cellspacing="0" cellpadding="0" width="100%"
                                border="0">
                                <tr >
                                    <td class="labelTD" align="left" style="width: 130px">
                                        <asp:Label ID="lblDivision" runat="server" CssClass="FieldName" Width="75px" meta:resourcekey="lblDivisionResource1"></asp:Label>
                                    </td>
                                    <td class="ControlTD">
                                        <asp:TextBox ID="txtDivision" runat="server" Width="227px" CssClass="FieldValue"
                                            MaxLength="50" Height="16px" TabIndex="1" meta:resourcekey="txtDivisionResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="reqDivision" runat="server" CssClass="ErrValStyle"
                                            ControlToValidate="txtDivision" meta:resourcekey="reqDivisionResource1"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revDivision" runat="server" ControlToValidate="txtDivision"
                                            CssClass="ErrValStyle" Display="Dynamic" ValidationExpression="^[\w0-9\-\.]+$"
                                            Height="15px" Width="166px" meta:resourcekey="revDivisionResource1"></asp:RegularExpressionValidator>
                                    </td>
                                ...
                                <tr>
                                    <td class="labelTD" align="left" style="width: 130px">
                                        <asp:Label ID="lblDesc" runat="server" CssClass="FieldName" Width="75px" meta:resourcekey="lblDescResource1"></asp:Label>
                                    </td>
                                    <td class="ControlTD" style="height: 36px" valign="top" colspan="2">
                                        <table class="leftaligned" align="left" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td class="ControlTD">
                                                    <asp:TextBox ID="txtDesc" runat="server" Width="226px" CssClass="FieldValue" MaxLength="150"
                                                        TabIndex="2" TextMode="MultiLine" Height="71px" meta:resourcekey="txtDescResource1"></asp:TextBox>
                                ...
                                <tr>
                                    <td style="height: 7px; width: 130px;">
                                        &nbsp;
                                    </td>
                                            ...
                                            <tr>
                                                <td align="left" colspan="2" valign="top" style="height: 30px; width: 398px;">
                                                    ...
                                                    <igtxt:WebImageButton ID="ibReset" runat="server" UseBrowserDefaults="False" CausesValidation="False"
                                                        OnClick="ibReset_Click" SkinID="uwButton" ImageDirectory="" TabIndex="4" meta:resourcekey="ibResetResource1">
                                                    </igtxt:WebImageButton>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <td style="height: 27px; width: 130px;">
                                    </td>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td style="width: 100%; margin-left: 40px;" align="left">
                                                    <ig:WebDataGrid ID="grdDivision" runat="server" AutoGenerateColumns="False" DataKeyFields="DivisionID"
                                                        Width="98%" EnableRelativeLayout="True" OnItemCommand="grdDivision_ItemCommand"
                                                        OnDataFiltered="grdDivision_DataFiltered" OnDataBound="grdDivision_DataBound"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <ig:BoundDataField DataFieldName="DivisionDesc" Key="DivisionDesc">
                                                                <Header Text="Description" />
                                                            </ig:BoundDataField>
                                                            <ig:TemplateDataField Key="Edit">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ImageUrl="~/images/edit_line.gif" runat="server" CausesValidation="False"
                                                                        CommandArgument='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "DivisionID") %>'
                                                            ...
                                                            <ig:TemplateDataField Key="Delete">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblDeleteID" runat="server" Text='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "DivisionID") %>'
