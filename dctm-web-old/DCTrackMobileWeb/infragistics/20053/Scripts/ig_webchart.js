 ...
 * [KV 7/7/2005, 10:12 AM] - Merged the javascripts in one.
 */
...
{
	// Public Properties
	this.ScriptVersion		="5.3.20053.1096"; 
...
function IGUltraChart(id, imageUrl, uniqueId)
{
	...
	{
		// Create instance
		/* SJZ 6/19/06 BR13761 - previously, .indexOf was being used, which only would remove the first part of the UniqueID. */
		...
		this.SB1				= new IGScrollBar(idPrefix + "_SB1", vals[2], vals[3],  30, this.ImageUrl, "", this.UniqueID);
		this.SB2				= new IGScrollBar(idPrefix + "_SB2", vals[9], vals[10], 30, this.ImageUrl, "vertical", this.UniqueID);
