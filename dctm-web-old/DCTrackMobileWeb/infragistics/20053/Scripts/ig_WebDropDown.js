...
function igdrp_evt(e)
{
	...
	var o,t=e.type,src=e.srcElement,all=igdrp_all;
...
function igdrp_combo(elem,props,ce)
{
	...
	this.DropButton.Image=igdrp_getElementById(this.Id+"_img");
	...
	this.onKeyDown=function(oEditor,value,oEvent)
	{
    	...
    	ig_fireEvent(me,me.Events.EditKeyDown[0],k,oEvent);
	...
	this.onKeyUp=function(oEditor,value,oEvent)
	{
		...
		if(me&&me.Loaded)ig_fireEvent(me,me.Events.EditKeyUp[0],oEvent.event.keyCode,oEvent);
	}
...
function igdrp_mouseDown(evnt)
{
	...
	var e=evnt.srcElement,container=me.Id+"_container";
	if(!e)if((e=evnt.target)==null)e=this;
...
function igdc_new(id,prop,df,ce,calID)
{
	...
	if(me&&me.doEvt&&elem)
	{
		...
		me.postField=me.elemCal=me.container=me.Element=me.inputBox=me.Calendar=null;
		ig_dispose(me);
	}
	...
	if(document.all)ig_csom.addEventListener(me.Element,"resize",igdrp_evt);
	ig_csom.addEventListener(me.DropButton.Image,'keypress',igdrp_evt);
	...
	me._msV=function(d,fire)
	{
		...
		if(this.old==d||fire==1)return;
		this.update("Value",this.old=d);
		if(fire&&this.inputBox.onchange)this.inputBox.onchange();
	}
...
function igmask_date(e,di,v,lf,nullTxt,nullable)
{
	...
	this.doKey=function(e,a)
	{
		...
		if(a==2)
		{
			...
			{
				this.changed=true;
				if(this.k0<32){this._msV();return;}
			}
