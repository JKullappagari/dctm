...
{
	var o=igtab_all[id],e0=document.getElementById(id);
	
	if(o&&o.element)
	{
		o.element=o.elemEmpty=o.elemState=o.rows=o._ajax=o.Event=null;
		var t,i=o.Tabs.length;
		while(i-->0)if((t=o.Tabs[i])!=null)t.element=t.elemDiv=t.elemIframe=t.elemLeft=t.elemRight=t.owner=null;
		t=o.buttons;
		i=t?t.length:0;
		while(i-->0)if(t[i]){t[i].owner=null;t[i]=null;}
		if(e0)ig_dispose(o);
	}
	if(!prop||(o=igtab_getElementById("igtab"+id))==null)return;
	ig_csom._postTab=false;
	igtab_all[id]=o=new igtab_new(o,id,seps,prop,evts,e0);
...
function igtab_event(e)
{
	...
	var i,p,b,z=igtab_all,o=e.srcElement,type=0;
...
function igtab_new(elem,id,seps,prop,evts,e0)
{
	...
	{
		if(this.fireEvt(this,this.Events.beforeCBResponse))return;
		var t,v;
	...
	this.afterCBResponse=function(){return this.fireEvt(this,this.Events.afterCBResponse);}
	...
	evts.beforeCBSubmit=this.val(prop0,6);
	evts.beforeCBResponse=this.val(prop0,7);
	evts.afterCBResponse=this.val(prop0,8);
	this.Events=evts;
	this.Tabs=new Array();
	...
	this.fireEvt=function(o,evtName,e)
	{
		...
		evt.reset();
		evt.event=e;
		ig_fireEvent(owner,evtName,o,evt);
