<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" CodeFile="ApplicationType.aspx.cs" Inherits="ApplicationType"
    Title="Application Type" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                            ...
                            <table id="Table3" style="height: 100%;" cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr style="height: 15px;">
                                    <td class="labelTD" align="left">
                                        <asp:Label ID="lblApplType" runat="server" CssClass="FieldName" Width="120px" meta:resourcekey="lblApplTypeResource1"></asp:Label>
                                    </td>
                                    <td class="ControlTD" style="height: 34px">
                                        <asp:TextBox ID="txtApplType" runat="server" Width="227px" CssClass="FieldValue"
                                            MaxLength="50" Height="16px" TabIndex="1" meta:resourcekey="txtApplTypeResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="reqApplType" runat="server" CssClass="ErrValStyle"
                                            ControlToValidate="txtApplType" meta:resourcekey="reqApplTypeResource1"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revAppType" runat="server" ControlToValidate="txtApplType"
                                            CssClass="ErrValStyle" ValidationExpression="^[\w\-\.\:]+(\s{1}[\w\-\.\:]+)*\s{0,1}$"
                                            Display="Dynamic" Height="15px" Width="166px" meta:resourcekey="revAppTypeResource1"></asp:RegularExpressionValidator>
                                    </td>
                                    <td class="ControlTD" style="height: 34px">
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    <td class="labelTD" align="left">
                                        <asp:Label ID="lblDesc" runat="server" CssClass="FieldName" Width="120px" meta:resourcekey="lblDescResource1"> </asp:Label>
                                    </td>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td style="width: 100%; margin-left: 40px;" align="left">
                                                    <ig:WebDataGrid ID="grdApplType" runat="server" AutoGenerateColumns="False" DataKeyFields="ApplTypeID"
                                                        Width="98%" EnableRelativeLayout="True" OnItemCommand="grdApplType_ItemCommand"
                                                        OnDataFiltered="grdApplType_DataFiltered" OnDataBound="grdApplType_DataBound"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <ig:BoundDataField DataFieldName="ApplTypeDesc" Key="ApplTypeDesc">
                                                                <Header Text="Description" />
                                                            </ig:BoundDataField>
                                                            <ig:TemplateDataField Key="Edit">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ImageUrl="~/images/edit_line.gif" runat="server" CausesValidation="False"
                                                                        CommandArgument='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "ApplTypeID") %>'
                                                            ...
                                                            <ig:TemplateDataField Key="Delete">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblDeleteID" runat="server" Text='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "ApplTypeID") %>'
