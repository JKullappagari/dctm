<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/PopupMaster.master" AutoEventWireup="true"
    CodeFile="HostPopup.aspx.cs" Inherits="HostPopup" Title="Host" Culture="auto"
...
<asp:Content ID="Content_Host" ContentPlaceHolderID="GeneralPopupContentPlaceHolder"
    runat="Server">
                                ...
                                <tr>
                                    ...
                                    <td class="ControlTD" style="height: 25px" valign="top">
                                        ...
                                        <asp:RegularExpressionValidator ID="revHost" runat="server" ControlToValidate="txtHost"
                                            ...
                                            Display="Dynamic" Height="15px" Width="166px" meta:resourcekey="revHostResource1"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelTD" style="width: 72px;">
                                                ...
                                                <td style="width: 100%" align="left">
                                                    <div style="width: 100%">
                                                        <ig:WebDataGrid ID="grdHost" runat="server" AutoGenerateColumns="False" DataKeyFields="HostID"
                                                            Width="98%" EnableRelativeLayout="True" OnItemCommand="grdHost_ItemCommand" OnDataBound="grdHost_DataBound"
                                                            HeaderCaptionCssClass="GridHeader" Height="300px" TabIndex="7" OnInitializeRow="grdHost_InitializeRow">
                                                            <Columns>
