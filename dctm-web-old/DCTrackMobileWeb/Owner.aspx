<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" CodeFile="Owner.aspx.cs" Inherits="Owner" Title="Owner/Custodian"
                            ...
                            <table id="Table3" style="height: 100%;" cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td class="labelTD" style="width: 58px; text-align: left; height: 30px;">
                                        <asp:Label ID="lblFirstName" runat="server" CssClass="FieldName" Width="150px" Height="24px"
                                    ...
                                    <td class="ControlTD" style="height: 30px; width: 635px; margin-left: 40px;" valign="middle">
                                        <asp:TextBox ID="txtOwnerFName" runat="server" CssClass="FieldValue" MaxLength="50"
                                            Style="vertical-align: top" TabIndex="1" Width="245px" meta:resourcekey="txtOwnerFNameResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvOwnerFName" runat="server" ControlToValidate="txtOwnerFName"
                                            CssClass="ErrValStyle" Width="200px" meta:resourcekey="rfvOwnerFNameResource1"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revFName" runat="server" ControlToValidate="txtOwnerFName"
                                            CssClass="ErrValStyle" ValidationExpression="^[A-Za-z0-9\.]+(\s{1}[A-Za-z0-9\.]+)*\s{0,1}$"
                                            Display="Dynamic" Height="15px" Width="166px" meta:resourcekey="revFNameResource1"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelTD" style="width: 58px; text-align: left; height: 30px;">
                                        <asp:Label ID="lblLastName" runat="server" CssClass="FieldName" Width="150px" Height="24px"
                                            meta:resourcekey="lblLastNameResource1"></asp:Label>
                                    </td>
                                    <td class="ControlTD" style="height: 30px; width: 635px; margin-left: 40px;" valign="middle">
                                        <asp:TextBox ID="txtOwnerLName" runat="server" CssClass="FieldValue" MaxLength="50"
                                            Style="vertical-align: top" TabIndex="1" Width="245px" meta:resourcekey="txtOwnerLNameResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvOwnerLName" runat="server" ControlToValidate="txtOwnerLName"
                                            CssClass="ErrValStyle" meta:resourcekey="rfvOwnerLNameResource1" Width="200px"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="revLName" runat="server" ControlToValidate="txtOwnerLName"
                                            CssClass="ErrValStyle" ValidationExpression="^[A-Za-z0-9\.]+(\s{1}[A-Za-z0-9\.]+)*\s{0,1}$"
                                            Display="Dynamic" Height="15px" Width="166px" meta:resourcekey="revFNameResource1"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelTD" style="width: 58px; text-align: left; height: 28px;">
                                        <asp:Label ID="lblEmail" runat="server" CssClass="FieldName" Width="139px" Height="23px"
                                            meta:resourcekey="lblEmailResource1"></asp:Label>
                                    </td>
                                    <td class="ControlTD" style="height: 28px; width: 635px;" valign="middle">
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="FieldValue" Style="vertical-align: top" MaxLength="50"
                                            TabIndex="1" Width="245px" meta:resourcekey="txtEmailResource1"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="regEmailVal" runat="server" ControlToValidate="txtEmail"
                                            ...
                                            meta:resourcekey="regEmailValResource1"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelTD" style="width: 58px; text-align: left; height: 27px" valign="top">
                                        <asp:Label ID="lblDivison" runat="server" CssClass="FieldName" Width="155px" Height="16px"
                                            meta:resourcekey="lblDivisonResource1"></asp:Label>
                                    </td>
                                    <td class="ControlTD" style="height: 27px; width: 635px;" valign="top">
                                        <asp:DropDownList ID="ddlDivison" runat="server" CssClass="dropdownText" TabIndex="7"
                                            Width="196px" meta:resourcekey="ddlDivisonResource1">
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="left" valign="top">
                                                    <ig:WebDataGrid ID="grdOwner" runat="server" AutoGenerateColumns="False" DataKeyFields="OwnerID"
                                                        Width="98%" OnItemCommand="grdOwner_ItemCommand" OnDataFiltered="grdOwner_DataFiltered"
                                                        OnDataBound="grdOwner_DataBound" HeaderCaptionCssClass="GridHeader" TabIndex="13"
                                                        Height="300px">
                                                        <Columns>
                                                            ...
                                                            <ig:TemplateDataField Key="Edit">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ImageUrl="~/images/edit_line.gif" runat="server" CausesValidation="False"
                                                                        CommandArgument='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "OwnerID") %>'
                                                            ...
                                                            <ig:TemplateDataField Key="Delete">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblDeleteID" runat="server" Text='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "OwnerID") %>'
