<%@ Page Title="Import Asset-Application Details" Language="C#" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" Theme="SkinFile" CodeFile="ImportAppAssetMap.aspx.cs"
    Inherits="ImportAppAssetMap" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Master_ContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function onFileUploaded(e, args) {
            ...
            $.ajax({
                type: "POST",
                url: "ImportAppAssetMap.aspx/ShowFileStats",
                data: fileName,
