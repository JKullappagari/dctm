<%@ Page Title="Import Applications" Language="C#" MasterPageFile="~/iAssetTrackMasterPage.master"
    AutoEventWireup="true" Theme="SkinFile" CodeFile="ImportApplications.aspx.cs"
    Inherits="ImportApplications" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Master_ContentPlaceHolder" runat="Server">
    ...
    //<!--
        ...
        function onFileUploaded(e, args) {
            ...
            $.ajax({
                type: "POST",
                url: "ImportApplications.aspx/ShowFileStats",
                data: fileName,
                            ...
                            <table id="Table2" style="height: 100%;" cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td class="ControlTD" valign="top" style="width: 650px; height: 44px">
                                        <div>
                                            <ig:WebUpload ID="wuImportAsset" runat="server" ProgressUrl="IGUploadStatusHandler.ashx" MultipleFiles="false"
                                                ShowFileExtensionIcon="true" Width="623px" AutoStartUpload="false" OnUploadFinished="wuImportAsset_OnUploadFinished"
                                                Mode="Single">
                                                <AllowedExtensions>
                                    ...
                                    <td style="width: 100%" align="left" colspan="3">
                                        <div style="width: 100%">
                                            <ig:WebDataGrid ID="grdAsset" runat="server" AutoGenerateColumns="False" DataKeyFields="ID"
                                                Width="97%" EnableRelativeLayout="True" Height="290px" OnItemCommand="grdAsset_ItemCommand"
                                                OnDataBound="grdAsset_DataBound" HeaderCaptionCssClass="GridHeader" TabIndex="7"
                                                OnInitializeRow="grdAsset_InitializeRow">
                                                <Columns>
                                                    <ig:BoundDataField DataFieldName="Application" Key="Application">
                                                        <Header Text="Application" />
                                                    </ig:BoundDataField>
                                                    <ig:BoundDataField DataFieldName="AppCriticality" Key="AppCriticality">
                                                        <Header Text="AppCriticality" />
                                                    </ig:BoundDataField>
                                                    <ig:BoundDataField DataFieldName="AppType" Key="AppType">
                                                        <Header Text="AppType" />
                                                    </ig:BoundDataField>
                                                    <ig:BoundDataField DataFieldName="AppStatus" Key="AppStatus">
                                                        <Header Text="AppStatus" />
                                                    </ig:BoundDataField>
                                                    <ig:BoundDataField DataFieldName="Owner" Key="Owner">
                                                        <Header Text="Owner" />
                                                    </ig:BoundDataField>
                                                    <ig:BoundDataField DataFieldName="Vendor" Key="Vendor">
                                                        <Header Text="Vendor" />
                                                    </ig:BoundDataField>
