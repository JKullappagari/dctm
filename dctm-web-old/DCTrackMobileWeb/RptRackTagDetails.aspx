<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptRackTagDetails.aspx.cs" Inherits="RptRackTagDetails"
    ...
    <table cellpadding="0" cellspacing="0" style="vertical-align: top; width: 97%;">
        ...
        <tr>
            <td valign="top" align="left">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" ShowParameterPrompts="true" KeepSessionAlive="true" style="overflow:auto;"
                    Font-Names="Verdana" Font-Size="8pt" meta:resourcekey="ReportViewer1Resource1" Visible="true" ShowFindControls="false" ShowBackButton="false"
                    Height="350px">
                </rsweb:ReportViewer>
            </td>
        </tr>
