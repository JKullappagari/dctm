...
namespace DCTMRestAPI.Controllers
{
    ...
    public class WorldRegionsController : Controller
    {
        private readonly DCTrackContext _context;

        public WorldRegionsController(DCTrackContext context)
        {
            _context = context;
        ...
        /// <summary>
        /// Gets all world regions details
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <summary>
        /// Gets world regions details based on identifier
        /// </summary>
        // GET api/AFDirections/5
        [HttpGet("{WorldRegionId}")]
        [ProducesResponseType(typeof(TblWorldRegion), 200)]
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        ...
        /// <summary>
        /// Gets world regions details which are modified after Last Updated datetime
        /// </summary>
        // GET api/AFDirections/5
