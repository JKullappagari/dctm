...
namespace DCTMRestAPI.Controllers
{
    ...
    public class AuditCyclesController : Controller
    {
        private readonly DCTrackContext _context;

        public AuditCyclesController(DCTrackContext context)
        {
            _context = context;
        ...
        /// <summary>
        /// Gets audit cycle details based on identifier
        /// </summary>
        /// <param name="Id"></param>
        /// <returns></returns>
        // GET api/auditcycles/5
        [HttpGet("{Id}")]
        [ProducesResponseType(typeof(TblAuditCycle), 200)]
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        ...
        /// <summary>
        /// Gets audit cycle details which are modified after Last Updated datetime
        /// </summary>
        // GET api/auditcycles/5
        ...
        //// POST api/auditcycles
        //[HttpPost]
        //public void Post([FromBody]string value)
        //{
        //}

        //// DELETE api/auditcycles/5
        //[HttpDelete("{id}")]
